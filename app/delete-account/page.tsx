      ...
      <main className="min-h-screen bg-white text-[#171717]">
        <div className="mx-auto max-w-2xl px-6 py-16">
          ...
          <p className="mt-4 text-base leading-7 text-gray-600">
            ...
            personal data at any time. This page explains how, and what happens
            to your information.
          </p>
          ...
          <section className="mt-10">
            ...
            <p className="mt-4 text-gray-700">
              If you can&apos;t access the app, email us from the address on
              your account and we&apos;ll process the deletion within 30 days.
            </p>
            <a
          ...
          <section className="mt-10">
            ...
            <p className="mt-4 text-gray-700">
              Unum Sint maintains official parish sacramental records —
              baptisms, first communions, confirmations, holy orders, and
              marriages. These are the parish&apos;s permanent canonical
              register and are kept for legitimate religious and legal
              record-keeping reasons, even after an account is deleted. Where
              possible these records are disassociated from your login. A
              marriage record, for example, also belongs to your spouse and
              cannot be erased by one party alone.
            </p>
            <p className="mt-4 text-gray-700">
              If you believe a sacramental record should be corrected or
              removed, contact your parish or email us at{" "}
              <a
